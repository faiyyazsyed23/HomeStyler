...
const sofas = [
  {
    name: "Modern ",
    price: "$1,200",
    img: "/assets/images/walllight.jpg",
  },
  {
    name: "Classic ",
    price: "$980",
    img: "/assets/images/walllight2.jpg",
  },
  {
    name: "Minimalist ",
    price: "$1,050",
    img: "/assets/images/walllight3.jpg",
  },
  {
    name: "Luxury",
    price: "$1,500",
    img: "/assets/images/walllight1.jpg",
  },
];  
    ...
    <div className="bg-[#faf9f7]">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <h2 className="text-3xl font-semibold text-gray-800 mb-8 text-center">
          Discover Our Premium Wall light
        </h2>
