...
const sofas = [
  {
    name: "Modern ",
    price: "",
    img: "/assets/images/cushions and throws1.jpg",
  },
  {
    name: "Classic",
    price: "",
    img: "/assets/images/cushions and throws22.jpg",
  },
  {
    name: "Minimalist",
    price: "",
    img: "/assets/images/cushions and throws3.jpg",
  },
  {
    name: "Luxury ",
    price: "",
    img: "/assets/images/cushions and throws4.jpg",
  },
];
    ...
    <div className="bg-[#faf9f7]">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <h2 className="text-3xl font-semibold text-gray-800 mb-8 text-center">
          Discover Our cushions and throws
        </h2>
