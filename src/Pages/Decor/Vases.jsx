...
const sofas = [
  {
    name: "Modern ",
    price: "$1,200",
    img: "/assets/images/vases and plant pots1.jpg",
  },
  {
    name: "Classic ",
    price: "$980",
    img: "/assets/images/vases and plant pots2.jpg",
  },
  {
    name: "Minimalist ",
    price: "$1,050",
    img: "/assets/images/vases and plant pots3.jpg",
  },
  {
    name: "Luxury ",
    price: "$1,500",
    img: "/assets/images/vases and plant pots4.jpg",
  },
];
    ...
    <div className="bg-[#faf9f7]">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <h2 className="text-3xl font-semibold text-gray-800 mb-8 text-center">
          Discover Our vases and plant pots
        </h2>
